...
var achievement_schema_1 = require("./achievement.schema");
var study_item_schema_1 = require("./study-item.schema");
    ...
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                mongoose_1.MongooseModule.forFeature([
                    ...
                    { name: study_item_schema_1.StudyItem.name, schema: study_item_schema_1.StudyItemSchema }
                ])
            ],
