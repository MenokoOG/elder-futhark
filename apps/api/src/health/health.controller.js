...
var HealthController = function () {
    ...
    var HealthController = _classThis = /** @class */ (function () {
        ...
        HealthController_1.prototype.ok = function () {
    ...
    (function () {
        ...
        _ok_decorators = [(0, common_1.Get)()];
        __esDecorate(_classThis, null, _ok_decorators, { kind: "method", name: "ok", static: false, private: false, access: { has: function (obj) { return "ok" in obj; }, get: function (obj) { return obj.ok; } }, metadata: _metadata }, null, _instanceExtraInitializers);
