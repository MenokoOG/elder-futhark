...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.createUser = function (input) {
            return __awaiter(this, void 0, void 0, function () {
                var doc;
                return __generator(this, function (_a) {
                    doc = new this.userModel(input);
                    return [2 /*return*/, doc.save()];
                });
            });
        };
        UsersService_1.prototype.safeProfile = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                var u;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, { id: String(u._id), email: u.email, handle: u.handle }];
                    }
                });
            });
        };
